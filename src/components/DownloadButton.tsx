...
const DownloadButton: React.FC<DownloadButtonProps> = ({ onClick, isProcessing, isComplete }) => {
    ...
    <StyledWrapper>
      <div className="container">
        <label className="label" onClick={handleClick}>
          <input type="checkbox" className="input" checked={isChecked || isProcessing || isComplete} readOnly />
...
const StyledWrapper = styled.div`
  ...
  .label .circle {
    ...
    transition: all 0.4s ease;
    position: relative;
    box-shadow: 0 0 0 0 rgb(24, 22, 22);
    overflow: hidden;
  }
